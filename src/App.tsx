...
import { Instagram, Globe, Mail, MapPin, GraduationCap, Camera, Mic, PenTool, Moon, Sun, Languages } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
            ...
            >
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.src = "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80";
                }}
